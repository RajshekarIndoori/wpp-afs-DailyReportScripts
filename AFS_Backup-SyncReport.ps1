...
$EmailBody += "Please find attached AFS Sync and Backup Report; same has been uploaded into BOX location. Click <a href=https://Kyndryl.ent.box.com/folder/129675222846>here</a> to open <br> <br>" 
$EmailBody += "Thank you <br>"
$EmailBody += "WPP Kyndryl Azure Cloud Team <br> <br> <br>"
$EmailBody += "This is an automatic generated email, Please reachout to WPP AFS Team (wpp-afs-support@kyndryl.com) for any concerns.<br>"
$params = @{
