...
$EmailBody += "Please find attached AFS File Server Agent Details; same has been uploaded into BOX location. Click <a href=https://Kyndryl.ent.box.com/folder/129675222846>here</a> to open <br> <br>" 
$EmailBody += "Thank you <br>"
$EmailBody += "WPP Kyndryl Azure Cloud Team <br> <br> <br>"
$EmailBody += "This is an automatic generated email, Please reachout to WPP Kyndryl AFS Team (wpp-afs-support@kyndryl.com) for any concerns.<br>"
$params = @{
    To = 'wpp-afs-support@kyndryl.com','afs_rep.kzuz67jdh69rmznk@u.box.com'
    From = 'wpp-afs-support@kyndryl.com' 
