...
$EmailBody += "Please find attached AFS Capacity Report; same has been uploaded into BOX location. Click <a href=https://kyndryl.ent.box.com/folder/129675222846>here</a> to open <br> <br>" 
$EmailBody += "Thank you <br>"
$EmailBody += "WPP Kyndryl Azure Cloud Team <br> <br> <br>"
$EmailBody += "This is an automatic generated email, Please reachout to WPP Kynryl AFS Team (wpp-afs-support@kyndryl.com) for any concerns.<br>"
$params = @{
