...
$EmailBody += "Please find attached AFS Sync Report; same has been uploaded into BOX Location. Click <a href=https://kyndryl.ent.box.com/folder/129675222846>here</a> to open <br> <br>" 
